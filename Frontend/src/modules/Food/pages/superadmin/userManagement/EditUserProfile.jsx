...
//                         required
//                         className="w-full p-1.5 text-xs border border-zinc-200 dark:border-zinc-800 rounded-lg bg-zinc-50 dark:bg-zinc-950 focus:outline-none focus:border-[var(--primary)] text-zinc-800 dark:text-zinc-100"
//                       />
//                     </div>
//                     <div>
...
//                           onChange={handleChange}
//                           required
//                           className="w-full pl-8 p-1.5 text-xs border border-zinc-200 dark:border-zinc-800 rounded-lg bg-zinc-50 dark:bg-zinc-950 focus:outline-none focus:border-[var(--primary)] text-zinc-800 dark:text-zinc-100"
//                         />
//                       </div>
//                     </div>
//                     <div>
...
//                           onChange={handleChange}
//                           className="w-full p-2 text-xs border border-white/20 rounded-lg bg-black/20 text-white focus:outline-none focus:ring-2 focus:ring-white/50 cursor-pointer"
//                         >
...
//                           onChange={handleChange}
//                           className="w-full p-2 text-xs border border-white/20 rounded-lg bg-black/20 text-white focus:outline-none focus:ring-2 focus:ring-white/50"
//                         />
//                       </div>
//                     </div>
