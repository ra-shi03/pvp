      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-y-0 right-0 w-full max-w-xl md:max-w-2xl bg-zinc-50 dark:bg-zinc-950 border-l border-zinc-150 dark:border-zinc-850 z-[105] shadow-2xl flex flex-col h-full"
          >
            {/* Drawer Header */}
            <div className="px-6 py-5 bg-white dark:bg-zinc-900 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between flex-shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-[var(--primary)]/20 to-[var(--primary)]/5 text-[var(--primary)] flex items-center justify-center font-extrabold text-sm border border-[var(--primary)]/20 shadow-inner">
                  {admin.name
                    .split(" ")
                    .map((n) => n[0])
                    .join("")}
              ...
              <button
                onClick={onClose}
                className="p-2 rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-400 hover:text-zinc-600 active:scale-95 transition-all cursor-pointer"
              >
                <X size={16} />
              </button>
            </div>
            ...
            {/* Horizontal Tabs Row */}
            <div className="bg-white dark:bg-zinc-900 border-b border-zinc-100 dark:border-zinc-850 flex items-center gap-1 overflow-x-auto pb-0 px-4 py-2 flex-shrink-0 scrollbar-none select-none">
              {tabs.map((tab) => {
                const Icon = tab.icon
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 rounded-full text-xs font-bold transition-all flex-shrink-0 cursor-pointer ${
                      isActive
              ...
              <AnimatePresence mode="wait">
                ...
                {activeTab === "Personal" && (
                  <motion.div
                    ...
                    className="space-y-4"
                  >
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl p-6 space-y-4 shadow-sm">
                      <h4 className="text-xs font-extrabold text-[var(--primary)] uppercase tracking-wider">
                        Personal Info Details
                      </h4>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-1">
                        <div className="flex items-center gap-3">
                          <div className="p-3 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 text-zinc-400 rounded-xl">
                            <Mail size={16} />
                          </div>
                          <div>
                            <p className="text-[10px] text-zinc-400 font-semibold">Email Address</p>
                            <p className="text-xs font-bold text-zinc-800 dark:text-zinc-200 mt-0.5">{admin.email}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs font-bold text-zinc-800 dark:text-zinc-200 mt-0.5">{admin.phone}</p>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-[10px] text-zinc-400 font-semibold">HQ Location</p>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-[10px] text-zinc-400 font-semibold">Date Registered</p>
                            <p className="text-xs font-bold text-zinc-800 dark:text-zinc-200 mt-0.5">{admin.joinedDate}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl p-6 space-y-4 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-1">
                        <div className="p-4 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-2xl">
                          <p className="text-[10px] text-zinc-400 font-semibold">Franchise Type</p>
                          <p className="text-sm font-black text-zinc-800 dark:text-zinc-200 mt-1">{admin.type}</p>
                        </div>

                        <div className="p-4 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-2xl">
                          <p className="text-[10px] text-zinc-400 font-semibold">Total Stores Limit</p>
                          <p className="text-sm font-black text-zinc-800 dark:text-zinc-200 mt-1">
                            {admin.totalStores} {admin.totalStores === 1 ? "Store" : "Stores"}
                          </p>
                        </div>

                        <div className="p-4 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-2xl">
                          <p className="text-[10px] text-zinc-400 font-semibold">Active Managers</p>
                          <p className="text-sm font-black text-zinc-800 dark:text-zinc-200 mt-1">
                      ...
                      <div className="p-4 border border-zinc-155 border-zinc-200 dark:border-zinc-800 rounded-2xl flex items-start gap-3 bg-zinc-50/50 dark:bg-zinc-900/50">
                        <ShieldAlert size={18} className="text-[var(--primary)] flex-shrink-0 mt-0.5" />
                        <div>
                          <p className="text-xs font-bold text-zinc-800 dark:text-zinc-200">Legal Agreement & Limits</p>
                          <p className="text-[10px] text-zinc-400 font-semibold mt-1 leading-normal">
                      ...
                      <div className="divide-y divide-zinc-100 dark:divide-zinc-800 pt-1">
                        {GENERATED_DETAILS.stores.map((store, i) => (
                          <div key={i} className="py-3.5 flex items-center justify-between first:pt-0 last:pb-0">
                            <div>
                              <p className="text-xs font-extrabold text-zinc-800 dark:text-zinc-200">{store.name}</p>
                    ...
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl p-6 shadow-sm space-y-4">
                      ...
                      <div className="divide-y divide-zinc-100 dark:divide-zinc-800 pt-1">
                        {GENERATED_DETAILS.staff.map((employee, i) => (
                          <div key={i} className="py-3.5 flex items-center justify-between first:pt-0 last:pb-0">
                            <div>
                              <p className="text-xs font-extrabold text-zinc-800 dark:text-zinc-200">{employee.name}</p>
                              <p className="text-[10px] text-zinc-400 font-semibold mt-1 flex items-center gap-1.5">
                    ...
                    <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-3xl p-6 shadow-sm space-y-4">
                      ...
                      <div className="space-y-3 pt-1">
                        {GENERATED_DETAILS.orders.map((ord) => (
                          <div
                            key={ord.id}
                            className="p-4 bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-100 dark:border-zinc-800 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                          >
                            <div>
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <span className="text-[10px] text-zinc-400 font-semibold">{ord.time}</span>
                              ...
                              <span
                                className={`text-[8px] font-black px-2 py-0.5 rounded-full ${
                                  ord.status === "COMPLETED"
                                    ? "bg-green-50 dark:bg-green-950/20 text-green-600 border border-green-100 dark:border-green-950"
                                    : ord.status === "DELIVERING"
                                    ? "bg-blue-50 dark:bg-blue-950/20 text-blue-600 border border-blue-100 dark:border-blue-950"
                                    : "bg-rose-50 dark:bg-rose-950/20 text-rose-600 border border-rose-100 dark:border-rose-950"
                                }`}
                              >
                                {ord.status}
                              </span>
            ...
            <div className="p-6 border-t border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 flex-shrink-0 flex items-center justify-end">
              <button
                onClick={onClose}
                className="w-full sm:w-auto px-6 py-3.5 rounded-xl border border-zinc-200 dark:border-zinc-800 font-bold text-xs text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 active:scale-95 transition-all cursor-pointer"
              >
                Close Drawer
              </button>
            </div>
