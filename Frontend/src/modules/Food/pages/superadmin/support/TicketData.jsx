          ...
          <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800 text-sm">
            {filteredTickets.map((ticket, idx) => (
              <tr key={idx} className="hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors group">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <span className={`px-3 py-1 rounded-full text-xs font-bold ${ticket.status === 'Escalated' ? 'bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-400' :
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className={`flex items-center gap-1 ${ticket.priority === 'Critical' ? 'text-red-500' :
