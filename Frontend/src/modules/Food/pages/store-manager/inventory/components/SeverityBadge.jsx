...
export function SeverityBadge({ severity }) {
  switch (severity) {
    ...
    case "medium":
      return (
        <Badge className="bg-blue-50 hover:bg-blue-50 dark:bg-blue-950/20 text-blue-705 dark:text-blue-400 border border-blue-105 dark:border-blue-900/30 rounded-xl px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider select-none">
          Medium
        </Badge>
      );
    case "high":
      return (
        <Badge className="bg-amber-50 hover:bg-amber-50 dark:bg-amber-950/20 text-amber-707 dark:text-amber-400 border border-amber-100 dark:border-amber-900/30 rounded-xl px-2.5 py-0.5 text-[10px] font-black uppercase tracking-wider select-none animate-pulse">
          High
        </Badge>
      );
    case "critical":
