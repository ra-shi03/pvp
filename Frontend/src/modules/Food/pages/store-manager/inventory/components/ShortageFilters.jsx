...
export function ShortageFilters({ filters, onFilterChange, onReset }) {
  const severities = [
  ...
  const stores = [
    { label: "Indore Main Store", value: "st-indore-01" },
    { label: "Vijay Nagar Store", value: "st-indore-02" },
    { label: "Palasia Store", value: "st-indore-03" }
  ];
